...
import { Button, Checkbox, MultiSelect, Select, Stack, Text, Textarea, TextInput, Title } from '@mantine/core';
    ...
    <Stack p="lg">
      ...
      <Text>Committee: {committeeId}</Text>
        <Stack>
          ...
          <Checkbox
          label="Make private?"
          {...form.getInputProps('privateStatus')}
          />
          <MultiSelect
            label="Sponsors"
         ...
         <MultiSelect
          ...
          <Button type="submit" onClick={handleSubmit}>Submit Directive</Button>
        </Stack>
    </Stack>
  );
};
